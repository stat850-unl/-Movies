...
3. Five state are in high in Artors (Arkansa, Florida, ...) and two in low (arizona, north carolina)
nterpretations: 1. The negative sign suggests that, on average, as the percentage of artists increases, the state's number of workers tends to decrease slightly. 2. Percentage of artists is not a strong predictor of the overall workforce size. 3. Economic, demographic, or industry-specific factors may contribute to the overall workforce size.
## future work
