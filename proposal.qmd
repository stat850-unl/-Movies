...
-   Task 1: Clean and preprocess dataset \*\* Mahyar will set up the the environment, prepare the basic visualization, clean and preprocess the dataset using python \*\* Jing Wang will set up the the environment, prepare the basic visualization, clean and preprocess the dataset using R
