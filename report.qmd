...
Pearson correlation coefficients were computed to analyze the relationship between the percentage of artists in a state (**`artists_share`**) and the state's number of workers (**`all_workers_n`**).
